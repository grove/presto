...
public class JacksonLazyTopicBuilder implements PrestoLazyTopicBuilder {
    ...
    public JacksonLazyTopicBuilder(JacksonDataProvider dataProvider, PrestoType type, String topicId) {
...
//        }
    ...
    public PrestoTopic build() {
        ...
        JacksonLazyTopic result = new JacksonLazyTopic(dataProvider, data);
